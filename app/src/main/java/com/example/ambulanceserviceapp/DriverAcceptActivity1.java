...
public class DriverAcceptActivity1 extends AppCompatActivity {
    private String areaname, bookingid;
    private Button acceptAmbulancebtn, gobackbtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver_accept1);
        ...
        acceptAmbulancebtn= (Button) findViewById(R.id.acceptAmbulanceBtn);
        ...
        acceptAmbulancebtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FirebaseFirestore db = FirebaseFirestore.getInstance();

                Task<QuerySnapshot> query =  db.collection("AmbulanceBooking").whereEqualTo("id", bookingid).get();
                ...
                db.collection("AmbulanceBooking")
                        ...
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(getApplicationContext(), "Ambulance Request Accepted Success", Toast.LENGTH_SHORT).show();
                            }
                        })
                        .addOnFailureListener(new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(getApplicationContext(), "Ambulance Request Accepted Failed", Toast.LENGTH_SHORT).show();
                            }
                        });
            }
        });
