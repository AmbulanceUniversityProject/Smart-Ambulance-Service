...
public class NewAmbulanceClass {
    ...
    public NewAmbulanceClass(String id, String ambulanceName, String vehicleNum, String saetedFor, String price_km, String hospitalName, String imageId, String areaname) {
        Id = id;
